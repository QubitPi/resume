...
\cvsection{履历概述}
    ...
    \begin{itemize}
        ...
        \item 带领团队的技术开发工作：设计软件架构，编写重点难点代码，负责前后端运维所有代码审核，集成 CI/CD + HashiCorp + AWS 实现 100\% 全自动化软件部署，利用 Agile 开发模式保证软件高效运行
    ...
    \begin{itemize}
        \item 参与开发知识图谱平台核心功能，并努力推进团队的技术标准化发展，例如帮助后端团队规范话软件开发流程，例如代码规范，引入自动化测试，和制定代码审核机制
